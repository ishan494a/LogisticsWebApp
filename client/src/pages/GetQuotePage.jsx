...
const TEMPLATE_ID = import.meta.env.VITE_EMAIL_TEMPLATE_ID_CONTACT;
...
const GetQuotePage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      setShipmentType('');
      setPickupAddress('');
      setPickupAppointment(false);
      setPickupStraightTruck(false);
      setPickupResidential(false);
      setPickupTailgate(false);
      setDeliveryAddress('');  
      setDeliveryAppointment(false);
      setDeliveryStraightTruck(false);
      setDeliveryResidential(false);
      setDeliveryTailgate(false);
      setNumberOfSkids('');
      setDimensions({ length: '', width: '', height: '' });
      setWeight('');
      setCommodity('');
      setHazardous(false);
      setFreezeProtection(false);
      setEquipmentType('');
